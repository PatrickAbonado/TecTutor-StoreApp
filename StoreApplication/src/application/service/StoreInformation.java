...
public class StoreInformation implements Display{
    ...
    public String chooseCategory(){
        ...
        while(true){
            ...
            try {
                ...
                System.out.println("Entry must be a valid integer number.");
        ...
        for (int i = 0; i < numProds; ++i){
            ...
            while(true){
                ...
                try{
                    ...
                    System.out.println("Price must be in a valid double format.");
                }
            ...
            while(true){
                ...
                try{
                    ...
                    System.out.println("Quantity must be a valid integer number.");
                }
    ...
    public void findProduct(){
        ...
        while(true){
            ...
            try{
                ...
                System.out.println("\nEnter only a valid integer number.");
            }
        ...
        if(!isFound){
            System.out.println("\nNo match was found for the entry provided.");
        }
    }
    ...
    public void listByCategory(){
        ...
        if(!isInCat){
            System.out.println("\nNo products of " + category + " are currently available.");
        }
    ...
    public void filterByPrice(){
        ...
        System.out.print("\n**** Available Products Sorted By Price ****");
    ...
    public void filterByCategory(){
        ...
        if(!isInCategory){
            System.out.println("\nNo products are currently available in " + category + ".");
        }
