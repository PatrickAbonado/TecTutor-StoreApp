...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        store.getProductDAO().getProductMap().put(1, new Product("peas", 2.00,8));
        store.getProductDAO().getProductMap().put(2, new Product("flounder", 10.00,5));
        store.getProductDAO().getProductMap().put(3, new Product("celery", 5.00,10));

        store.getItemDAO().getItemArrayList().add(new Item("peas","Vegetables",2.00));
        store.getItemDAO().getItemArrayList().add(new Item("flounder","Grocery",10.00));
        store.getItemDAO().getItemArrayList().add(new Item("celery","Vegetables",5.00));
